...
class PaginationUtilsTest {
    ...
    @Test
    fun paginateStopsAfterLastPage() = runTest {
        var fetchCount = 0
        val items = paginate { page ->
            fetchCount++
    ...
    @Test
    fun paginateHandlesEmptyFirstPage() = runTest {
        val items = paginate { _ ->
    ...
    @Test
    fun paginateHandlesSinglePage() = runTest {
        val items = paginate { _ ->
    ...
    @Test
    fun paginateWithCustomStartPage() = runTest {
        val pages = mapOf(
    ...
    @Test
    fun paginateRejectsInvalidStartPage() = runTest {
    ...
    @Test
    fun paginateRejectsNegativeStartPage() = runTest {
        assertFailsWith<IllegalArgumentException> {
    ...
    @Test
    fun paginateStopsAtMaxPages() = runTest {
        var fetchCount = 0
        val items = paginate(maxPages = 2) { page ->
            fetchCount++
    ...
    @Test
    fun paginatePropagatesExceptionFromFetchPage() = runTest {
        val flow = paginate { page ->
    ...
    @Test
    fun paginateCancellationStopsFetching() = runTest {
        var fetchCount = 0
        val items = paginate { page ->
            fetchCount++
